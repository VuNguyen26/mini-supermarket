...
// //         form.add(cbProduct);
// //         form.add(new JLabel("SL hệ thống"));
// //         form.add(txtSystemQty);
// //         form.add(new JLabel("SL kiểm"));
// //         form.add(txtCountedQty);
...
// //         cbProduct.addActionListener(e -> loadSystemQty());
// //     }
...
// //         txtSystemQty.setText(String.valueOf(detail.getSystemQty()));
...
// //             try {
// //                 int qty = service.getSysQtyById(p.getProductId());
// //                 txtSystemQty.setText(String.valueOf(qty));
// //             } catch (Exception e) {
// //                 txtSystemQty.setText("0");
...
// //                 d.setSystemQty(Integer.parseInt(txtSystemQty.getText()));
