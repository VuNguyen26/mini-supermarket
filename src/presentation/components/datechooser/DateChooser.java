...
import presentation.components.datechooser.layout.CellLayout;
import presentation.components.datechooser.layout.HeaderLayout;
import presentation.components.datechooser.listener.DateChooserAction;
import presentation.components.datechooser.listener.DateChooserListener;
import presentation.components.datechooser.render.DateChooserRender;
import presentation.components.datechooser.render.DefaultDateChooserRender;
...
public class DateChooser extends JPanel {
	...
	public void setTextField(JTextField textField) {
		...
		textField.setCaret(new DefaultCaret() { @Override public void paint(Graphics g) { } });
	...
	public void last28Days() {
		DateBetween last28Days = new DateBetween();
		last28Days.setLast28Days();
		setSelectedDateBetween(last28Days);
	}
	...
	private void init() {
		...
		spMonth.setUI(new BasicSpinnerUI() {
	...
	private void createHeader() {
		...
		URL backIconUrl = getClass().getResource("/icons/arrowCollapse.svg");
		URL nextIconUrl = getClass().getResource("/icons/arrowExpand.svg");
		JButton cmdBack = new JButton(new FlatSVGIcon(backIconUrl));
		JButton cmdNext = new JButton(new FlatSVGIcon(nextIconUrl));
