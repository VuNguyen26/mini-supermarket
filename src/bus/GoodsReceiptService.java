...
public class GoodsReceiptService {
    ...
    public String getUserNameById(int id) {
        return grDAO.getUserFullName(id) + " (" + id + ")";
    }
    ...
    public boolean createFullReceipt(GoodsReceipt gr, List<GoodsReceiptDetail> details) {
        ...
        try {
            ...
            for (GoodsReceiptDetail detail : details) {
                ...
                if (grdId == -1) {
                    throw new SQLException("Failed to save Detail for Product " + detail.getProductId());
                }
                ...
                if (!lotDAO.insert(con, lot)) {
                    throw new SQLException("Failed to create inventory lot for product " + detail.getProductId());
                }
            }
            ...
            auditLogService.log(
                    ...
                    "goods_receipt",
                    (long) grId,
                    "Tạo phiếu nhập kho ID " + grId + " với " + details.size() + " sản phẩm"
            );
